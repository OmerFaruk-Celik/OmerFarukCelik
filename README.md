...
<p>
  <img src="https://img.shields.io/badge/Embedded%20Systems-STM32%20%7C%20ESP32%20%7C%20nRF52-blue?style=for-the-badge" />
  <img src="https://img.shields.io/badge/AI%20%2F%20Machine%20Learning-CNN%20%7C%20EfficientNet%20%7C%20TensorFlow-orange?style=for-the-badge" />
  <img src="https://img.shields.io/badge/Computer%20Vision-OpenCV%20%7C%20Object%20Detection-green?style=for-the-badge" />
  <img src="https://img.shields.io/badge/Underwater%20Systems-AUV%20%7C%20Acoustic%20Comm%20%7C%20Electric%20Field-lightblue?style=for-the-badge" />
  <img src="https://img.shields.io/badge/Autonomous%20Robotics-ROS%20%7C%20Gazebo%20%7C%20Path%20Planning-purple?style=for-the-badge" />
  <img src="https://img.shields.io/badge/PCB%20%26%20Electronics-KiCad%20%7C%20Analog%20Circuits-yellow?style=for-the-badge" />
</p>
...
<p style="max-width:800px;"> Bu bölüm TNC Group şirketleri bünyesinde tamamladığım staj süresince geliştirdiğim mini projeler, dokümanlar ve tasarımları içermektedir. Hem yazılım hem tasarım tarafındaki yetkinliklerimi gösteren küçük ama etkili örneklerdir. </p> <br> <!-- CARD 1 --> <div style="border:1px solid #ddd; border-radius:12px; padding:20px; width:80%; margin-bottom:25px; box-shadow:0px 0px 10px #eee;"> <h2>📘 Python Kullanma Kılavuzu</h2> <a href="./PythonKullanmaKilavuzu.pdf"> <img src="./kilavuz.png" width="300px" /> </a> <br><br> <a href="./PythonKullanmaKilavuzu.pdf" style="font-size:18px; font-weight:bold;">📄 PDF Dosyasını Aç</a> </div> <!-- CARD 2 --> <div style="border:1px solid #ddd; border-radius:12px; padding:20px; width:80%; margin-bottom:25px; box-shadow:0px 0px 10px #eee;"> <h2>📝 Python To-Do List Uygulaması</h2> <a href="./PythonToDoList.py"> <img src="./Excel.png" width="300px" /> </a> <br><br> <a href="./PythonToDoList.py" style="font-size:18px; font-weight:bold;">🧩 Kod Dosyasını Görüntüle</a> </div> <!-- CARD 3 --> <div style="border:1px solid #ddd; border-radius:12px; padding:20px; width:80%; margin-bottom:25px; box-shadow:0px 0px 10px #eee;"> <h2>📊 Excel Tabanlı Profesyonel CV</h2> <a href="./OmerFarukCelik.xlsx"> <img src="./Excel.png" width="300px" /> </a> <br><br> <a href="./OmerFarukCelik.xlsx" style="font-size:18px; font-weight:bold;">📊 CV (XLSX) Dosyasını Aç</a> </div> <!-- CARD 4 --> <div style="border:1px solid #ddd; border-radius:12px; padding:20px; width:80%; margin-bottom:25px; box-shadow:0px 0px 10px #eee;"> <h2>🎨 Photoshop Poster Tasarımı — Spiderman</h2> <a href="./Spiderman.webp"> <img src="./Spiderman.webp" width="400px" /> </a> <br><br> <a href="./Spiderman.webp" style="font-size:18px; font-weight:bold;">🖼️ Poster Görselini Aç</a> </div> <!-- CARD 5 --> <div style="border:1px solid #ddd; border-radius:12px; padding:20px; width:80%; margin-bottom:25px; box-shadow:0px 0px 10px #eee;"> <h2>📁 TNC Group Genel Portföy PDF</h2> <a href="./OmerFarukCelik.pdf"> <img src="./AutoCAD.png" width="300px" /> </a> <br><br> <a href="./OmerFarukCelik.pdf" style="font-size:18px; font-weight:bold;">📄 Genel PDF Portföyü Aç</a> </div> </div>
## 📬 İletişim
...
<p align="center">
  ...
  <br>Portföyümü inceleyebilir, projelerime göz atabilirsiniz!
</p>
